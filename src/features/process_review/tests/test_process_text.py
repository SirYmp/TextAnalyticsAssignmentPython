import unittest
from src.features.process_text.normalize import expand_contractions, convert_case, remove_special_characters, \
...
class TestProcessTest(unittest.TestCase):
    ...
    def test_lemmatize_text(self):
        ...
        solution = "the dog be funny. the dog be jump over the brown fox."
